...
/**
 * Linear RGB (0-1) to OKLab. Skips sRGB curve; input is already linear.
 */
...
/**
 * Quantize linear RGB (0-1) to sRGB 0-255 for export.
 */
export function linearRgbToSrgb8(r: number, g: number, b: number): {
  r: number;
  g: number;
  b: number;
} {
