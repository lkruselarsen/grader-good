...
export default function LabPage() {
  ...
  return (
    <div>
      <PageHeader title="Lab 1" href="/lab" />
          ...
          <ScrollArea className="flex-1 max-h-[calc(100vh-12rem)] lg:max-h-[calc(100vh-10rem)]">
            <div className="space-y-4 pr-4">
                    ...
                    <ProgressWithLabel
                      ...
                      value={
                        ...
                        embeddingProgress.total > 0
                          ? (100 * (embeddingProgress.current ?? 0)) /
                            embeddingProgress.total
                          : undefined
                      }
                      label={`${embeddingProgress.phase}${
                        embeddingProgress.total != null &&
                        embeddingProgress.total > 0
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setUseTileSearch(checked === true)
                    }
                    disabled={isUsingEmbeddings}
                  />
                  <Label htmlFor="use-tile-search" className="text-sm">
              ...
              <section className="space-y-3">
                ...
                <Accordion
                  type="multiple"
                  defaultValue={PARAM_SECTIONS.map((s) => s.id)}
                  className="w-full"
                >
                {PARAM_SECTIONS.map((section) => {
                  ...
                  return (
                    <AccordionItem key={`${section.id}-${section.label}`} value={section.id}>
                        ...
                        <>
                          ...
                          <div className="flex items-center gap-2">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) =>
                                setModel2RobustSampling(checked === true)
                              }
                            />
              ...
              <section className="flex gap-2 flex-wrap items-center">
                <div className="flex flex-col gap-1 min-w-0">
                  ...
                  {isApplying && (
                    <ProgressWithLabel
                      className="max-w-[200px]"
                      label={applyProgress ?? "Running pipeline…"}
                      indeterminate
                    />
                  )}
                </div>
                ...
                <LoadingButton
                  ...
                  loading={isExporting}
                  loadingText={exportProgress ?? "Exporting…"}
                  size="sm"
                >
                  Export full-res
                </LoadingButton>
                <LoadingButton
                  ...
                  loading={isExportingLow}
                  loadingText="Exporting low…"
                  size="sm"
                >
                  Export low (70%)
                </LoadingButton>
